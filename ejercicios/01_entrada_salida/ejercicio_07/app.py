...
class App(customtkinter.CTk):
    ...
    def btn_multiplicar_on_click(self):
        ...
        alert(title = "Resultado", message = f"El resultado de la multiplicación es: {multiplicacion}")
    ...
    def btn_dividir_on_click(self):
        ...
        alert(title = "Resultado", message = f"El resultado de la division es: {division}")
