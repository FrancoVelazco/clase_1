...
class App(customtkinter.CTk):
    ...
    def btn_calcular_on_click(self):
        ...
        alert(title = "Información", message = f"Los metros cuadrados del terreno son: {metros_cuadrados} y los metros lineales son {metros_lineales}.\n\nLos materiales necesarios son:\nQuebracho Grueso: {quebracho_grueso}\nQuebracho Fino: {quebracho_fino}\nVarillas: {varillas}\nAlambre alta resistencia: {alambre}")
